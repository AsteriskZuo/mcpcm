...
- [`cli/AGENTS.md`](cli/AGENTS.md) for the TypeScript CLI package.
...
Example:
- CLI change: run commands from `cli/` and follow `cli/AGENTS.md`.
...
- PR descriptions should include:
  - changed module(s): `cli`, `api`, or both,
